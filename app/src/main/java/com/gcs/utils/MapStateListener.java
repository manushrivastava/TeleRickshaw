...
public abstract class MapStateListener {
    ...
    public MapStateListener(GoogleMap map, TouchableMapFragment supportMapFragment, Activity activity) {
        this.mMap = map;
        ...
        supportMapFragment.setTouchListener(new TouchableWrapper.OnTouchListener() {
            @Override
            public void onTouch() {
                touchMap();
                unsettleMap();
